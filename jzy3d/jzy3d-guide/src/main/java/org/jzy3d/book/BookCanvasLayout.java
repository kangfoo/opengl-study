...
public class BookCanvasLayout
  extends AbstractAnalysis
{
  public static void main(String[] paramArrayOfString)
  {
    ChartLauncher.SCREENSHOT_FOLDER = "./data/book/";
    AnalysisLauncher.open(paramArrayOfString = new BookCanvasLayout());
    ChartLauncher.screenshot(paramArrayOfString.getChart(), "data/book/" + BookCanvasLayout.class.getSimpleName() + ".png");
  }
  ...
  public void init()
  {
    ...
    ((AWTColorbarLegend)localObject2).setScreenGridDisplayed(true);
  }
}


/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\book\BookCanvasLayout.class
