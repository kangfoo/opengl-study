...
public class BookMaximizedOff
  extends AbstractAnalysis
{
  public static void main(String[] paramArrayOfString)
  {
    ChartLauncher.SCREENSHOT_FOLDER = "./data/book/";
    AnalysisLauncher.open(paramArrayOfString = new BookMaximizedOff(), new Rectangle(0, 0, 600, 300));
    ChartLauncher.screenshot(paramArrayOfString.getChart(), "data/book/" + BookMaximizedOff.class.getSimpleName() + ".png");
  }
  ...
  public void init()
  {
    ...
    this.chart.getView().setMaximized(false);
    this.chart.getView().getCamera().setScreenGridDisplayed(true);
  }
}


/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\book\BookMaximizedOff.class
