...
public class BookMaximizedOn
  extends AbstractAnalysis
{
  public static void main(String[] paramArrayOfString)
  {
    ChartLauncher.SCREENSHOT_FOLDER = "./data/book/";
    AnalysisLauncher.open(paramArrayOfString = new BookMaximizedOn(), new Rectangle(0, 0, 600, 300));
    ChartLauncher.screenshot(paramArrayOfString.getChart(), "data/book/" + BookMaximizedOn.class.getSimpleName() + ".png");
  }
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\book\BookMaximizedOn.class
