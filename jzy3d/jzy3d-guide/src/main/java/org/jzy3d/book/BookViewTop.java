...
public class BookViewTop
  extends AbstractAnalysis
{
  public static void main(String[] paramArrayOfString)
  {
    ChartLauncher.SCREENSHOT_FOLDER = "./data/book/";
    AnalysisLauncher.open(paramArrayOfString = new BookViewTop());
    ChartLauncher.screenshot(paramArrayOfString.getChart(), "data/book/" + BookViewTop.class.getSimpleName() + ".png");
  }
  
  public void init()
  {
    Object localObject1 = new i(this);
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\book\BookViewTop.class
