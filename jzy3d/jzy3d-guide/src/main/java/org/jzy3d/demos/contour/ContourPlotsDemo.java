...
public class ContourPlotsDemo
  extends AbstractAnalysis
{
  public static void main(String[] paramArrayOfString)
  {
    AnalysisLauncher.open(new ContourPlotsDemo());
  }
  ...
  public void init()
  {
    ...
    ContourAxeBox localContourAxeBox = (ContourAxeBox)this.chart.getView().getAxe();
    localObject = new MapperContourPictureGenerator((Mapper)localObject, localRange1, localRange2);
    localContourAxeBox.setContourImg(((MapperContourPictureGenerator)localObject).getContourImage(new DefaultContourColoringPolicy(localColorMapper), 400, 400, 10), localRange1, localRange2);
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\demos\contour\ContourPlotsDemo.class
