  ...
  extends AbstractAnalysis
{
  ...
  {
    (paramArrayOfString = new HeightMapDemo()).init();
  ...
  public void init()
  {
    ...
    (localContourAxeBox = (ContourAxeBox)this.chart.getView().getAxe()).setContourImg(((MapperContourPictureGenerator)localObject).getHeightMap(new DefaultContourColoringPolicy(localColorMapper), 400, 400, 10), localRange1, localRange2);
    this.chart.addDrawable(localShape);
    localShape.setLegend(new AWTColorbarLegend(localShape, new RegularTickProvider(10), this.chart.getView().getAxe().getLayout().getZTickRenderer()));
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\demos\contour\HeightMapDemo.class
