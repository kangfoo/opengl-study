  ...
  extends AbstractAnalysis
{
  ...
  public void init()
  {
    ...
    (localNewtMousePickingController = new NewtMousePickingController(this.chart, (int)d)).getPickingSupport().addObjectPickedListener(new b(this, (PointGraph2d)localObject));
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\demos\graphs\PickableGraphDemo.class
