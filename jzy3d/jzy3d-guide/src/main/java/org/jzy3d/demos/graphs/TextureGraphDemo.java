  ...
  extends AbstractAnalysis
{
  ...
  {
    AnalysisLauncher.openStatic(paramArrayOfString = new TextureGraphDemo());
  }
  ...
  public void init()
  {
    ...
    DefaultGraphFormatter localDefaultGraphFormatter = new DefaultGraphFormatter();
    ...
    Object localObject = "data/textures/masks/arrow-bg-mask-100-100.png";
    localObject = new TextureGraph2d((String)localObject);
    NewtMousePickingController localNewtMousePickingController;
    (localNewtMousePickingController = new NewtMousePickingController(this.chart)).getPickingSupport().addObjectPickedListener(new c(this, (TextureGraph2d)localObject));
    ((TextureGraph2d)localObject).setGraphModel(localIGraph, localNewtMousePickingController.getPickingSupport());
    ((TextureGraph2d)localObject).setGraphFormatter(localDefaultGraphFormatter);
    ((TextureGraph2d)localObject).setGraphLayout(localDefaultGraphLayout2d);
    this.chart.getScene().getGraph().add((AbstractDrawable)localObject);
  }
}


/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\demos\graphs\TextureGraphDemo.class
