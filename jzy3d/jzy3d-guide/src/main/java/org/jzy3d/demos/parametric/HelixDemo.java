  ...
  extends AbstractAnalysis
{
  ...
  {
    AnalysisLauncher.open(new HelixDemo());
  }
  
  public void init()
  {
    Color localColor = new Color(0.0F, 0.2509804F, 0.32941177F);
    ParametricHelix localParametricHelix = new ParametricHelix(5.0D, 0.2D);
    this.chart = initializeChart(Quality.Advanced);
    this.chart.getScene().getGraph().add(new ParametricDrawable(localParametricHelix, 0.0D, a * 10.0D, 10000, localColor));
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\demos\parametric\HelixDemo.class
