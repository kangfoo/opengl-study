  ...
  extends AbstractAnalysis
{
  ...
  {
    AnalysisLauncher.open(new BuildSurfaceDemo());
  }
  ...
  public void init()
  {
    ...
    localShape.setLegendDisplayed(true);
    localShape.setLegend(new AWTColorbarLegend(localShape, this.chart.getView().getAxe().getLayout()));
    this.chart.getScene().getGraph().add(localShape);
  }
}


/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\notshowing\BuildSurfaceDemo.class
