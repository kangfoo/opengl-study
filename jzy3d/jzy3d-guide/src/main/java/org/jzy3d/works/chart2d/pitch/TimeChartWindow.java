...
public class TimeChartWindow
  extends JFrame
{
  public TimeChartWindow(List<Chart> paramList)
  {
    LookAndFeel.apply();
    String str = "[300px]";
    ...
    localObject1 = this;
    addWindowListener(new c((TimeChartWindow)localObject1));
    pack();
    show();
    setVisible(true);
  }
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\works\chart2d\pitch\TimeChartWindow.class
