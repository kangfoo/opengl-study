...
public class TrialFaceOrdering1
{
  ...
  {
    paramArrayOfString = paramArrayOfString = new TrialFaceOrdering1();
    Object localObject1 = new AWTChartComponentFactory();
    (localObject1 = new Chart((IChartComponentFactory)localObject1, Quality.Advanced, "newt")).getAxeLayout().setZTickRenderer(new ScientificNotationTickRenderer(1));
    ...
    Object localObject5 = new d(paramArrayOfString);
    Object localObject6 = new Range(-150.0F, 150.0F);
    localObject6 = new OrthonormalGrid((Range)localObject6, 50, (Range)localObject6, 50);
    e locale = new e(paramArrayOfString);
    paramArrayOfString.e = ((Shape)locale.build(((OrthonormalGrid)localObject6).apply((Mapper)localObject5)));
    ...
    ((View)localObject3).addViewPointChangedListener(new f(paramArrayOfString));
...
/* Location:              D:\\jzy3d-guide-1.0-demos-exe\jzy3d-guide-1.0.0-SNAPSHOT\lib\jzy3d-guide-1.0.0-SNAPSHOT.jar!\org\jzy3d\works\various\TrialFaceOrdering1.class
